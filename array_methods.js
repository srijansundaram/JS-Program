...
console.log(arr.slice(2, 4)); // index 4 element is not included
console.log(arr.slice(-2)); // -1 is the last element of the array
console.log(arr.slice(1, -2));
console.log(arr.slice()); //exact same console.log([...arr]);
*/
...
/*
arr.splice(-1);
console.log(arr); // extracted elements are actually gone from the original array, splice deleted them.
arr.splice(1, 2);
console.log(arr);
*/
...
// continue and break doesn't work in 'for each'
// 0: function(200)
// 1: function(450)
// 2: function(400)
